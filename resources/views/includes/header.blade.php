    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                ...
                <form action="" method="get" class="main-header-center d-none d-lg-block">
                    <input class="form-control" placeholder="Search for anything..." type="search" name="s" value="{{@$s}}"> <button class="btn" type="submit"><i class="fa fa-search d-none d-md-block"></i></button>
                </form>
                <!-- End::header-link -->
            </div>
            <!-- End::header-element -->
