...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <div>
        <h4 class="mb-0">{{ trans('label.visit_record_detail_edit') }}</h4>
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ trans('label.homepage') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ trans('label.visit_record_detail_edit') }}</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="tab-content">
                    ...
                    <form action="{{route('view.visit_guidance_record_detail.update', ['id' => $model->detail_id])}}" method="post" enctype="multipart/form-data" class="container-fluid">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="visit_record_id" class="form-label">{{ trans('label.visit_record_id') }}</label>
