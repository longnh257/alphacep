...
<form action="{{route('view.visit_guidance_record_detail.store',$visit_record_id)}}" method="post" enctype="multipart/form-data" class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <h4 class="mb-0">{{ trans('label.visit_record_detail_add') }}</h4>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ trans('label.homepage') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ trans('label.visit_record_detail') }}</li>
            </ol>
        </div>
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        {{ trans('label.visit_record_detail_info') }}
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="visit_date" class="form-label">{{ trans('label.visit_date') }}</label>
                            <input type="date" class="form-control" name="visit_date" id="visit_date" value="{{ old('visit_date') }}">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="visit_time" class="form-label">{{ trans('label.visit_time') }}</label>
                            <input type="text" class="form-control" name="visit_time" id="visit_time" value="{{ old('visit_time') }}">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="reflect_div" class="form-label">{{ trans('label.reflect_div') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="training_progress" class="form-label">{{ trans('label.training_progress') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="training_level" class="form-label">{{ trans('label.training_level') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="time_allowcation" class="form-label">{{ trans('label.time_allowcation') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="training_attitube" class="form-label">{{ trans('label.training_attitube') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="training_willingness" class="form-label">{{ trans('label.training_willingness') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="japanese_understanding" class="form-label">{{ trans('label.japanese_understanding') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="life_attitude" class="form-label">{{ trans('label.life_attitude') }}</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="discipline_violation" class="form-label">{{ trans('label.discipline_violation') }}</label>
