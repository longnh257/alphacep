...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1"> {{ trans('visit_guidance_record_detail.visit_record_detail') }}</h5>
            <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div>
                <a href="{{route('view.audit_report.create')}}" class="btn btn-info btn-icon btn-b" target="_blank">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12" id="list-data">
            <div class="card card-table">
                <div class=" card-header p-0 d-flex justify-content-between">
                    <h4 class="card-title mb-1">{{ trans('visit_guidance_record_detail.table_title') }}</h4>
                    ...
                    <table class="table table-striped table-bordered mb-0 text-nowrap gridjs-table">
                        <thead class="gridjs-thead">
                            <tr class="gridjs-tr">
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('visit_guidance_record_detail.company_id') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('visit_guidance_record_detail.company_office_id') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('visit_guidance_record_detail.audit_date') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('visit_guidance_record_detail.last_audit_date') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('visit_guidance_record_detail.next_audit_date') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                        ...
                        <tbody>
                            <tr v-for="item in list" :key="item.audit_report_id">
                                <td>((item.audit_report_id))</td>
                                ...
                                <td>
                                    <div class="hstack gap-2 ">
                                        ...
                                        <form :action="`{{asset('audit-report')}}/`+item.audit_report_id" :id="'formDelete_'+((item.audit_report_id))" class="pt-1" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="##" @click="deleteItem(item.audit_report_id)" class="text-danger fs-14 lh-1"><i class="ri-delete-bin-5-line"></i></a>
                                        </form>
                                    </div>
                                </td>
                            </tr>
    ...
    new Vue({
        ...
        methods: {
            ...
            onLoadPagination() {
                ...
                jQuery.ajax({
                    type: 'GET',
                    url: "{{route('api.audit_reports.list')}}" + conditionSearch,
