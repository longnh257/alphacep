        ...
        <div class="card custom-card    pt-4">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs tab-style-1 d-sm-flex d-block" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#trainee" aria-current="page" href="#trainee">{{ trans('label.trainee_info') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#trainee_relative" href="#trainee_relative">{{ trans('label.trainee_relative_info') }}</a>
                    </li>
                </ul>
                        ...
                        <form action="{{route('view.trainee.update', ['id' => $model->trainee_id])}}" method="post" enctype="multipart/form-data" class="container-fluid">
                            ...
                            <div class="row gy-4">
                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $model->name }}" placeholder="{{ trans('label.name') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="name_kana" class="form-label  required">{{ trans('label.name_kana') }}</label>
                                    <input type="text" class="form-control" name="name_kana" id="name_kana" value="{{ $model->name_kana }}" placeholder="{{ trans('label.name_kana') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="name_kanji" class="form-label  required">{{ trans('label.name_kanji') }}</label>
                                    <input type="text" class="form-control" name="name_kanji" id="name_kanji" value="{{ $model->name_kanji }}" placeholder="{{ trans('label.name_kanji') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="mobile_tel" class="form-label required">{{ trans('label.mobile_tel') }}</label>
                                    <input type="text" class="form-control" name="mobile_tel" id="mobile_tel" max="10" min="10" value="{{ $model->mobile_tel }}" placeholder="{{ trans('label.mobile_tel') }}">
                                </div>
                                ...
                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="occupation" id="occupation" value="{{ $model->occupation }}" placeholder="{{ trans('label.occupation') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="birth_place" class="form-label">{{ trans('label.birth_place') }}</label>
                                    <input type="text" class="form-control" name="birth_place" id="birth_place" value="{{ $model->birth_place }}" placeholder="{{ trans('label.birth_place') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="home_country_address" class="form-label">{{ trans('label.home_country_address') }}</label>
                                    <input type="text" class="form-control" name="home_country_address" id="home_country_address" value="{{ $model->home_country_address }}" placeholder="{{ trans('label.birth_place') }}">
                                </div>
                                ...
                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="applicant_tel" id="applicant_tel" max="10" min="10" value="{{ $model->applicant_tel }}" placeholder="{{ trans('label.applicant_tel') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="applicant_postcode" class="form-label">{{ trans('label.applicant_postcode') }}</label>
                                    <input type="text" class="form-control" name="applicant_postcode" id="applicant_postcode" value="{{ $model->applicant_postcode }}" placeholder="{{ trans('label.applicant_postcode') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="applicant_address1" class="form-label">{{ trans('label.applicant_address1') }}</label>
                                    <input type="text" class="form-control" name="applicant_address1" id="applicant_address1" value="{{ $model->applicant_address1 }}" placeholder="{{ trans('label.applicant_address1') }}">
                                </div>

                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    <label for="applicant_address2" class="form-label">{{ trans('label.applicant_address2') }}</label>
                                    <input type="text" class="form-control" name="applicant_address2" id="applicant_address2" value="{{ $model->applicant_address2 }}" placeholder="{{ trans('label.applicant_address2') }}">
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered mb-0 text-nowrap gridjs-table">
                                        <thead class="gridjs-thead">
                                            <tr class="gridjs-tr">
                                                ...
                                                <th class="gridjs-th gridjs-th-sort ">
                                                    <div class="flex-between-center">
                                                        <div class="gridjs-th-content">{{trans('label.relationship')}}</div>
                                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                                            <i class="fe fe-arrow-down"></i>
                                                        </button>
                                                    </div>
