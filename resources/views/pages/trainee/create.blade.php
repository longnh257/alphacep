                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" name="name_kanji" id="name_kanji" value="{{ old('name_kanji') }}" placeholder="{{ trans('label.name_kanji') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="mobile_tel" class="form-label required">{{ trans('label.mobile_tel') }}</label>
                            <input type="text" class="form-control" name="mobile_tel" id="mobile_tel" max="10" min="10" value="{{ old('mobile_tel') }}" placeholder="{{ trans('label.mobile_tel') }}">
                        </div>
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" name="occupation" id="occupation" value="{{ old('occupation') }}" placeholder="{{ trans('label.occupation') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="birth_place" class="form-label">{{ trans('label.birth_place') }}</label>
                            <input type="text" class="form-control" name="birth_place" id="birth_place" value="{{ old('birth_place') }}" placeholder="{{ trans('label.birth_place') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="home_country_address" class="form-label">{{ trans('label.home_country_address') }}</label>
                            <input type="text" class="form-control" name="home_country_address" id="home_country_address" value="{{ old('home_country_address') }}" placeholder="{{ trans('label.birth_place') }}">
                        </div>
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control" name="applicant_tel" id="applicant_tel" max="10" min="10" value="{{ old('applicant_tel') }}" placeholder="{{ trans('label.applicant_tel') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="applicant_postcode" class="form-label">{{ trans('label.applicant_postcode') }}</label>
                            <input type="text" class="form-control" name="applicant_postcode" id="applicant_postcode" value="{{ old('applicant_postcode') }}" placeholder="{{ trans('label.applicant_postcode') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="applicant_address1" class="form-label">{{ trans('label.applicant_address1') }}</label>
                            <input type="text" class="form-control" name="applicant_address1" id="applicant_address1" value="{{ old('applicant_address1') }}" placeholder="{{ trans('label.applicant_address1') }}">
                        </div>

                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="applicant_address2" class="form-label">{{ trans('label.applicant_address2') }}</label>
                            <input type="text" class="form-control" name="applicant_address2" id="applicant_address2" value="{{ old('applicant_address2') }}" placeholder="{{ trans('label.applicant_address2') }}">
                        </div>
