    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div class="pe-1 mb-xl-0">
                <a href="{{route('view.trainee.create')}}" class="btn btn-info btn-icon me-2 btn-b" target="_blank"> 
                            ...
                            <tr v-for="item in list" :key="item.trainee_id">
                                ...
                                <td>
                                    <div class="hstack gap-2 flex-wrap justify-content-end">
                                        ...
                                        <form :action="`{{asset('trainee')}}/`+item.trainee_id"  :id="'formDelete_'+((item.trainee_id))" class="pt-1" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="##" @click="deleteTrainee(item.trainee_id)" class="text-danger fs-14 lh-1"><i class="ri-delete-bin-5-line"></i></a>
                                        </form>
                                    </div>
                                </td>
                            </tr>
    ...
    new Vue({
        ...
        methods: {
            ...
            onLoadPagination() {
                ...
                jQuery.ajax({
                    type: 'GET',
                    url: "{{route('api.trainees.list')}}" + conditionSearch,
