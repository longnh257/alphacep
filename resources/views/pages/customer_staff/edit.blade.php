            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            <label for="customer_office_id" class="form-label required">{{ trans('label.customer_office_id') }}</label>
                            <select class="form-control" data-trigger name="customer_office_id" id="customer_office_id">
                                <option value="">Select Office</option>
                                @foreach($offices as $office)
                                <option value="{{$office->customer_office_id}}"  @if($office->customer_office_id == $customer_staff->customer_office_id ) selected @endif>ID: {{$office->customer_office_id}} - Name: {{$office->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select class="form-control" data-trigger name="sex" id="sex">
                                ...
                                <option value="F"  @if($office->customer_office_id == "F" ) selected @endif>Female</option>
                                <option value="O"  @if($office->customer_office_id == "0" ) selected @endif>Others</option>
                            </select>
                        </div>
