...
@section('content')
<form action="{{route('view.customer_staff.store')}}" method="post" enctype="multipart/form-data" class="container-fluid">
    @csrf
    <!-- Page Header -->
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="main-dashboard-header-right">
            <div class="d-flex my-xl-auto right-content align-items-center">
                ...
                <div class="pe-1 mb-xl-0">
                    <a href="{{route('view.customer_staff.index')}}" class="btn btn-danger btn-icon me-2 btn-b">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="  col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select class="form-control" data-trigger name="customer_office_id" id="customer_office_id">
                                ...
                                <option value="{{$office->customer_office_id}}">ID: {{$office->customer_office_id}} - Name: {{$office->name}}</option>
                                @endforeach
                            </select>
                        </div>
