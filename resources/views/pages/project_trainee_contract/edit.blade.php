...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <div>
        <h4 class="mb-0">{{ trans('label.project_trainee_contract_edit') }}</h4>
    </div>
                    ...
                    <form action="{{route('view.project_trainee_contract.update', ['id' => $project_trainee_contract->contract_id])}}" method="post" enctype="multipart/form-data" class="container-fluid">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="practitioner_group_id" id="practitioner_group_id" value="{{ $project_trainee_contract->practitioner_group_id }}" placeholder="{{ trans('label.practitioner_group_id') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_place_name" class="form-label">{{ trans('label.work_place_name') }}</label>
                                <input type="text" class="form-control" name="work_place_name" id="work_place_name" value="{{ $project_trainee_contract->work_place_name }}" placeholder="{{ trans('label.work_place_name') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="postcode" class="form-label">{{ trans('label.postcode') }}</label>
                                <input type="text" class="form-control" name="postcode" id="postcode" value="{{ $project_trainee_contract->postcode }}" placeholder="{{ trans('label.postcode') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="address1" class="form-label">{{ trans('label.address1') }}</label>
                                <input type="text" class="form-control" name="address1" id="address1" value="{{ $project_trainee_contract->address1 }}" placeholder="{{ trans('label.address1') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="address2" class="form-label">{{ trans('label.address2') }}</label>
                                <input type="text" class="form-control" name="address2" id="address2" value="{{ $project_trainee_contract->address2 }}" placeholder="{{ trans('label.address2') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="transition_occupation_id1" class="form-label">{{ trans('label.transition_occupation_id1') }}</label>
                                <input type="text" class="form-control" name="transition_occupation_id1" id="transition_occupation_id1" value="{{ $project_trainee_contract->transition_occupation_id1 }}" placeholder="{{ trans('label.transition_occupation_id1') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="transition_occupation_id2" class="form-label">{{ trans('label.transition_occupation_id2') }}</label>
                                <input type="text" class="form-control" name="transition_occupation_id2" id="transition_occupation_id2" value="{{ $project_trainee_contract->transition_occupation_id2 }}" placeholder="{{ trans('label.transition_occupation_id2') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="transition_occupation_id3" class="form-label">{{ trans('label.transition_occupation_id3') }}</label>
                                <input type="text" class="form-control" name="transition_occupation_id3" id="transition_occupation_id3" value="{{ $project_trainee_contract->transition_occupation_id3 }}" placeholder="{{ trans('label.transition_occupation_id3') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="other_transition_occupation" class="form-label">{{ trans('label.other_transition_occupation') }}</label>
                                <input type="text" class="form-control" name="other_transition_occupation" id="other_transition_occupation" value="{{ $project_trainee_contract->other_transition_occupation }}" placeholder="{{ trans('label.other_transition_occupation') }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="training_no1_certification_number" id="training_no1_certification_number" value="{{ $project_trainee_contract->training_no1_certification_number }}" placeholder="{{ trans('label.training_no1_certification_number') }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="training_no2_certification_number" id="training_no2_certification_number" value="{{ $project_trainee_contract->training_no2_certification_number }}" placeholder="{{ trans('label.training_no2_certification_number') }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="training_no3_certification_number" id="training_no3_certification_number" value="{{ $project_trainee_contract->training_no3_certification_number }}" placeholder="{{ trans('label.training_no3_certification_number') }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="work_hours_per_day" id="work_hours_per_day" value="{{ $project_trainee_contract->work_hours_per_day }}" placeholder="{{ trans('label.work_hours_per_day') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_week" class="form-label">{{ trans('label.work_hours_per_week') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_week" id="work_hours_per_week" value="{{ $project_trainee_contract->work_hours_per_week }}" placeholder="{{ trans('label.work_hours_per_week') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_week_decimal_notation" class="form-label">{{ trans('label.work_hours_per_week_decimal_notation') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_week_decimal_notation" id="work_hours_per_week_decimal_notation" value="{{ $project_trainee_contract->work_hours_per_week_decimal_notation }}" placeholder="{{ trans('label.work_hours_per_week_decimal_notation') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_month" class="form-label">{{ trans('label.work_hours_per_month') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_month" id="work_hours_per_month" value="{{ $project_trainee_contract->work_hours_per_month }}" placeholder="{{ trans('label.work_hours_per_month') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_month_decimal_notation" class="form-label">{{ trans('label.work_hours_per_month_decimal_notation') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_month_decimal_notation" id="work_hours_per_month_decimal_notation" value="{{ $project_trainee_contract->work_hours_per_month_decimal_notation }}" placeholder="{{ trans('label.work_hours_per_month_decimal_notation') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_year" class="form-label">{{ trans('label.work_hours_per_year') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_year" id="work_hours_per_year" value="{{ $project_trainee_contract->work_hours_per_year }}" placeholder="{{ trans('label.work_hours_per_year') }}">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="work_hours_per_year_decimal_notation" class="form-label">{{ trans('label.work_hours_per_year_decimal_notation') }}</label>
                                <input type="text" class="form-control" name="work_hours_per_year_decimal_notation" id="work_hours_per_year_decimal_notation" value="{{ $project_trainee_contract->work_hours_per_year_decimal_notation }}" placeholder="{{ trans('label.work_hours_per_year_decimal_notation') }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="training_span_period" id="training_span_period" value="{{ $project_trainee_contract->training_span_period }}" placeholder="{{ trans('label.training_span_period') }}">
                            </div>
