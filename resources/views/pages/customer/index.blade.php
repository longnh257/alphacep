...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div>
                <a href="{{route('view.customer.create')}}" class="btn btn-info btn-icon btn-b" target="_blank"> 
                                ...
                                <td>
                                    <div class="hstack gap-2 ">
                                        ...
                                        <form :action="`{{asset('customer')}}/`+item.customer_id"  :id="'formDelete_'+((item.customer_id))" class="pt-1" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="##" @click="deleteItem(item.customer_id)" class="text-danger fs-14 lh-1"><i class="ri-delete-bin-5-line"></i></a>
                                        </form>
                                    </div>
                                </td>
                            </tr>
