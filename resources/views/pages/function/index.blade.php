...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1"> {{ trans('function.function') }}</h5>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ trans('common.homepage') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ trans('function.function') }}</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div>
                <a href="{{route('view.function.create')}}" class="btn btn-info btn-icon btn-b" target="_blank">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12" id="list-data">
            <div class="card card-table">
                <div class=" card-header p-0 d-flex justify-content-between">
                    <h4 class="card-title mb-1">{{ trans('function.table_title') }}</h4>
                ...
                <div class="table-responsive country-table">
                    <table class="table table-striped table-bordered mb-0 text-nowrap gridjs-table">
                            ...
                            <tr class="gridjs-tr">
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('function.id') }}</div>
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('function.name') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('function.category_id') }}</div>
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('function.url') }}</div>
                                        <button class="btn btn-outline-success btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                        ...
                        <tbody>
                            <tr v-for="item in list" :key="item.function_id">
                                <td>((item.function_id))</td>
                                <td class="fw-medium">((item.function_name))</td>

                                <td class="fw-medium">((item.category_id))</td>
                                <td class="fw-medium">((item.url))</td>
                                <td>
                                    <div class="hstack gap-2 ">
                                        <a :href="`{{asset('function')}}/`+item.function_id+`/edit`" class="text-info fs-14 lh-1"><i class="ri-edit-line"></i></a>
    ...
    new Vue({
        ...
        methods: {
            ...
            onLoadPagination() {
                ...
                jQuery.ajax({
                    type: 'GET',
                    url: "{{route('api.functions.list')}}" + conditionSearch,
