...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1"> {{ trans('project_work_task.project') }}</h5>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ trans('common.homepage') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ trans('project_work_task.project') }}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12 col-lg-12 col-xl-12" id="list-data">
            <div class="card card-table">
                <div class=" card-header p-0 d-flex justify-content-between">
                    <h4 class="card-title mb-1">{{ trans('project_work_task.table_title') }}</h4>
                    ...
                    <table class="table table-striped table-bordered mb-0 text-nowrap gridjs-table">
                        <thead class="gridjs-thead">
                            <tr class="gridjs-tr">
                                ...
                                <th class="gridjs-th gridjs-th-sort ">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('project_work_task.trainee_number') }}</div>
                                        <button class="btn btn-outline-light btn-wave waves-effect waves-light">
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('project_work_task.entry_date') }}</div>
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('project_work_task.sending_agency') }}</div>
                                        <button class="btn btn-outline-success btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('project_work_task.company') }}</div>
                                        <button class="btn btn-outline-success btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                                ...
                                <th class="gridjs-th gridjs-th-sort">
                                    <div class="flex-between-center">
                                        <div class="gridjs-th-content">{{ trans('project_work_task.url') }}</div>
                                        <button class="btn btn-outline-success btn-wave waves-effect waves-light">
                                            <i class="fe fe-arrow-down"></i>
                                        </button>
                                    </div>
                            ...
                            <tr v-for="item in list" :key="item.project_id">
                                ...
                                <td>
                                    <div class="hstack gap-2 ">
                                        <a :href="`{{asset('project-trainee/create')}}/`+item.project_id" class="text-info fs-14 lh-1" title="{{trans('project_work_task.add-project-trainee')}}"><i class="si si-user-follow"></i></a>
