...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1">  {{ trans('trainee_relative.trainee_relative') }}</h5>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">  {{ trans('common.homepage') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">  {{ trans('trainee_relative.trainee_relative') }}</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center">
            <div>
                <a href="{{route('view.trainee_relative.create')}}" class="btn btn-info btn-icon btn-b" target="_blank"> 
        ...
        <div class="col-md-12 col-lg-12 col-xl-12" id="list-data">
            <div class="card card-table">
                <div class=" card-header p-0 d-flex justify-content-between">
                   {{ trans('trainee_relative.table_title') }}
                            ...
                            <tr v-for="item in list" :key="item.relative_id">
                                ...
                                <td>
                                    <div class="hstack gap-2 ">
                                        <a :href="`{{asset('trainee_relative')}}/`+item.relative_id+`/edit`" class="text-info fs-14 lh-1"><i class="ri-edit-line"></i></a>
                                        <form :action="`{{asset('trainee_relative')}}/`+item.relative_id"  :id="'formDelete_'+((item.relative_id))" class="pt-1" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="##" @click="deleteItem(item.relative_id)" class="text-danger fs-14 lh-1"><i class="ri-delete-bin-5-line"></i></a>
                                        </form>
                                    </div>
                                </td>
                            </tr>
