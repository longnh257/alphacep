                            ...
                            <div class="row gy-4">
                                ...
                                <div class="  col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" data-trigger name="customer_id" id="customer_id">
                                        ...
                                        <option value="{{$customer->customer_id}}" @if($customer->customer_id == $customer_office->customer_id ) selected @endif>ID: {{$customer->customer_id}} - Name: {{$customer->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
