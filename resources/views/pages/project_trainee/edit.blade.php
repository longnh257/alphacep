                                            ...
                                            <tr v-for="item in list" :key="item.project_trainee_contract_id">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 flex-wrap justify-end">
                                                        ...
                                                        <form :action="`{{asset('project-trainee-contract')}}/`+item.contract_id" :id="'formDelete'+((item.contract_id))" class="pt-1" method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                            <a href="##" @click="deleteOffice(item.contract_id)" class="text-danger fs-14 lh-1"><i class="ri-delete-bin-5-line"></i></a>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
